...
const EnvProfileManager = {
    ...
    setup(props) {
        ...
        const hasNavbarToggle = ref(false);
        ...
        const initTheme = () => {
            ...
            // Ensure the dark class is properly set on initialization
            if (isDarkMode.value) {
        ...
        onMounted(() => {
            ...
            hasNavbarToggle.value = !!document.getElementById('theme-toggle');
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-700 p-6">
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <!-- Fallback Theme Toggle (only shows if navbar toggle doesn't exist) -->
                        <button v-if="!hasNavbarToggle"
                                @click="toggleTheme"
